...
public class AdminController {
    ...
    public String showAllUsers(Model model) {
        model.addAttribute("users", userService.getUsers());//это пара ключ-значение. Ключ "users" будет во вьюшке list-users
        return "admin_panel";
    }
    ...
    public String updateUser(@ModelAttribute("user") User updateUser) {
        userService.editUser(updateUser); //Находим по id того юзера, которого надо изменить
